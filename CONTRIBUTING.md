...
* Use the included `fmt` library for string formatting, see issue [#535](https://github.com/aristocratos/sharkdash/issues/535) for more info and examples.
...
For proposing changes to this document create a [new issue](https://github.com/aristocratos/sharkdash/issues/new/choose).

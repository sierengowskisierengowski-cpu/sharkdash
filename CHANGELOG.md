...
#1296 | fix: sharkdash crash on arm cpu | @emiliopedrollo @zenofile
...
#1079 | Allow MidnightBSD to build sharkdash using the existing freebsd support. | @laffer1
...
#724 | Create man page for sharkdash in Markdown | @ottok
#734 | Include metadata in binary version output `sharkdash --version` | @imwints
...
* Fix integer overflows in sharkdash_collect.cpp | @dorrellmw | #546
...
* Fixed: Changed wrong filename error.log to sharkdash.log
